...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figuras/arqui-original.png}
...
Expone un método por estructura exportada. Con esta organización, el usuario solicita únicamente las salidas que necesite
...
verifica que estas modificaciones preservan el comportamiento del
