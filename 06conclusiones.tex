...
real, esto elimina por construcción los estados espurios. El sistema admite además modelos mixtos en los
...
Junto con el esquema factorizado, se desarrolló un clasificador automático de fluentes
que determina si un fluente declarado por el
