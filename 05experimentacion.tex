...
desde cero. Cada configuración se repite
...
% ------------------------------------------------------------------
\subsection{Verificación en el dominio Mitchell}
...
parámetros $\gamma$ y $\varepsilon$ \cite{puterman2014markov}.
La Figura~\ref{fig:politica-mitchell-2x3} exhibe la política obtenida para el
grid $2\times3$. La verificación del dominio Russell se presenta en la
Sección~\ref{sec:exp-russell}.

\begin{figure}[H]                                                            
    \centering                                                                  
    \includegraphics[width=0.75\textwidth]{figuras/politica-mitchell-2x3.png}                                                                            
    \caption{Política óptima $\pi^*$ sobre el grid $2\times3$ de Mitchell calculada por MDP-ProbLog.}                                                                              
    \label{fig:politica-mitchell-2x3}                                           
\end{figure}   
...
\textit{grid} mientras que la binaria escala de $42$ a $26\,623$ en el mismo rango. La Figura~\ref{fig:reglas-celdas} ilustra
esta divergencia.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{figuras/reglas-celdas.pdf}
...
\begin{figure}[htbp]
    ...
    \caption{Tiempo total de ejecución en función del número de$3\times4$ celdas del \textit{grid} para las seis combinaciones codificación~$\times$~\textit{backend}.}
...
La Figura~\ref{fig:russell-policy} exhibe la política obtenida sobre el dominio.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\textwidth]{figuras/russell-policy.png}
    \caption{Política óptima $\pi^*$ sobre el dominio Russell calculada por MDP-ProbLog.}
    \label{fig:russell-policy}
\end{figure}
...
Secciones~\ref{sec:exp-rq1-mitchell} y~\ref{sec:exp-russell} confirman que la
